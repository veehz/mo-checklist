"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[724],{3361:function(e,t,i){i.d(t,{C:function(){return tc},a5:function(){return tt},aa:function(){return ti},ab:function(){return tr},ak:function(){return ts},am:function(){return ta},o:function(){return im},y:function(){return tl}});var r,n=i(5816),s=i(4444),a=i(3333),o=i(7582),l=i(8463);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eL(e,t){return b(e,"POST","/v1/accounts:signInWithPassword",P(e,t))}async function eU(e,t){return O(e,"POST","/v1/accounts:sendOobCode",P(e,t))}async function eD(e,t){return eU(e,t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e8(e,t,i=!1){if((0,n.rh)(e.app))return Promise.reject(g(e));let r="signIn",s=await e9(e,r,t),a=await e3._fromIdTokenResponse(e,r,s);return i||await e._updateCurrentUser(a.user),a}async function e7(e,t){return e8(ey(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function te(e){let t=ey(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}async function tt(e,t,i){let r=ey(e),n={requestType:"PASSWORD_RESET",email:t,clientType:"CLIENT_TYPE_WEB"};if(i){var s;_((null===(s=i.url)||void 0===s?void 0:s.length)>0,r,"invalid-continue-uri"),_(void 0===i.dynamicLinkDomain||i.dynamicLinkDomain.length>0,r,"invalid-dynamic-link-domain"),n.continueUrl=i.url,n.dynamicLinkDomain=i.dynamicLinkDomain,n.canHandleCodeInApp=i.handleCodeInApp,i.iOS&&(_(i.iOS.bundleId.length>0,r,"missing-ios-bundle-id"),n.iOSBundleId=i.iOS.bundleId),i.android&&(_(i.android.packageName.length>0,r,"missing-android-pkg-name"),n.androidInstallApp=i.android.installApp,n.androidMinimumVersionCode=i.android.minimumVersion,n.androidPackageName=i.android.packageName)}await eP(r,n,"getOobCode",eD)}async function ti(e,t,i){if((0,n.rh)(e.app))return Promise.reject(g(e));let r=ey(e),s=eP(r,{returnSecureToken:!0,email:t,password:i,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",e1),a=await s.catch(t=>{throw"auth/password-does-not-meet-requirements"===t.code&&te(e),t}),o=await e3._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(o.user),o}function tr(e,t,i){return(0,n.rh)(e.app)?Promise.reject(g(e)):e7((0,s.m9)(e),eJ.credential(t,i)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&te(e),t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tn(e,t){return O(e,"POST","/v1/accounts:update",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ts(e,{displayName:t,photoURL:i}){if(void 0===t&&void 0===i)return;let r=(0,s.m9)(e),n=await r.getIdToken(),a=await $(r,tn(r.auth,{idToken:n,displayName:t,photoUrl:i,returnSecureToken:!0}));r.displayName=a.displayName||null,r.photoURL=a.photoUrl||null;let o=r.providerData.find(({providerId:e})=>"password"===e);o&&(o.displayName=r.displayName,o.photoURL=r.photoURL),await r._updateTokensIfNecessary(a)}function ta(e,t){return to((0,s.m9)(e),null,t)}async function to(e,t,i){let{auth:r}=e,n={idToken:await e.getIdToken(),returnSecureToken:!0};t&&(n.email=t),i&&(n.password=i);let s=await $(e,eN(r,n));await e._updateTokensIfNecessary(s,!0)}function tl(e,t,i,r){return(0,s.m9)(e).onAuthStateChanged(t,i,r)}function tc(e){return(0,s.m9)(e).signOut()}new WeakMap;let tu="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tA extends eb{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return eV(e,this._buildIdpRequest())}_linkToIdToken(e,t){return eV(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return eV(e,this._buildIdpRequest())}_buildIdpRequest(e){let t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function tL(e){return e8(e.auth,new tA(e),e.bypassAuthState)}function tU(e){let{auth:t,user:i}=e;return _(i,t,"internal-error"),e6(i,new tA(e),e.bypassAuthState)}async function tD(e){let{auth:t,user:i}=e;return _(i,t,"internal-error"),e5(i,new tA(e),e.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tY=new T(3e4,6e4);function tQ(){let e=tv().___jsl;if(null==e?void 0:e.H){for(let t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}}let tZ=null,t0=new T(5e3,15e3),t1={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},t3=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);async function t2(e){let t=await (tZ=tZ||new Promise((t,i)=>{var r,n,s,a;function o(){tQ(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{tQ(),i(f(e,"network-request-failed"))},timeout:tY.get()})}if(null===(n=null===(r=tv().gapi)||void 0===r?void 0:r.iframes)||void 0===n?void 0:n.Iframe)t(gapi.iframes.getContext());else if(null===(s=tv().gapi)||void 0===s?void 0:s.load)o();else{let t=ek("iframefcb");return tv()[t]=()=>{gapi.load?o():i(f(e,"network-request-failed"))},(a=`${eE.gapiScript}?onload=${t}`,eE.loadJS(a)).catch(e=>i(e))}}).catch(e=>{throw tZ=null,e})),i=tv().gapi;return _(i,e,"internal-error"),t.open({where:document.body,url:function(e){let t=e.config;_(t.authDomain,e,"auth-domain-config-required");let i=t.emulator?E(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,r={apiKey:t.apiKey,appName:e.name,v:n.Jn},a=t3.get(e.config.apiHost);a&&(r.eid=a);let o=e._getFrameworks();return o.length&&(r.fw=o.join(",")),`${i}?${(0,s.xO)(r).slice(1)}`}(e),messageHandlersFilter:i.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:t1,dontclear:!0},t=>new Promise(async(i,r)=>{await t.restyle({setHideOnLeave:!1});let n=f(e,"network-request-failed"),s=tv().setTimeout(()=>{r(n)},t0.get());function a(){tv().clearTimeout(s),i(t)}t.ping(a).then(a,()=>{r(n)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
